//
//  InfoDetailsTableViewController.m
//  FMR
//
...
#import "InfoDetailsTableViewC.h"

@interface InfoDetailsTableViewController ()

@end

@implementation InfoDetailsTableViewController
...
{
    InfoDetailsTableViewC *cell = [tableView dequeueReusableCellWithIdentifier:@"InfoDetailsTableViewC" forIndexPath:indexPath];
